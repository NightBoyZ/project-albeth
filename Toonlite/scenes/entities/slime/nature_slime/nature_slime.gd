...
@export var bounce_strength : float = 4.0
@export var gravity : float = ProjectSettings.get_setting("physics/3d/default_gravity")

@export_group("Combat Modifiers")
@export var health: int = 10
@export var stat_scaling: int = 1
@export var score_points: int = 30
@export var experience_points: int = 7
...
@onready var projectile = preload("res://scenes/entities/slime/nature_slime/toxic_cloud.tscn")
...
"splash": preload("res://scenes/vfx/slime/splash.tscn"), 
"target": preload("res://scenes/vfx/environment/target_decal.tscn"), 
...
func spawn_goo(puddle_size: int):
	...
	spawn.color = enemy_model.mesh.material.albedo_color
	spawn.glow = enemy_model.mesh.material.emission
	add_sibling(spawn)
