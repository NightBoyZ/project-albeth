...
@export var bounce_strength : float = 24.0
...
@export var score_points: int = 15
...
@onready var projectile = preload("res://scenes/entities/slime/fire_slime/fireball.tscn")
